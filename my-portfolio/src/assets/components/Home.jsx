...
const Home = () => {
  ...
  return (
    <section ref={ref} name='home' className=' min-h-screen md:px-32 md:py-[52px] px-6 py-5'>
      <div className=' flex justify-center items-center md:hidden h-[30vh] relative w-full z-[-10] py-8'>
      ...
      <div className='flex md:flex-row flex-col md:space-x-28 items-center md:py-6 py-1.5 md:mt-0 mt-[52px] '>
        <div className=' text-white md:w-full '>{inView && <div><h3 className=' md:text-[21px] text-[16.5px]  tx opacity-0'>Hello, My Name is</h3>
          <h1 className=' md:text-[36px] text-[26px]  tx opacity-0  font-Calistoga '>Abdul Ahad</h1>
          <h1 className=' flex gap-3 md:text-[36px] text-[25px] tx opacity-0' ><p>I'm a </p><p className=' text-[#0ef] font-extrabold  font-Great'>{text}</p> <Cursor cursorColor='#0ef' /></h1>
          <div className='tx md:text-[18px] text-[15px] md:py-2 py-1 opacity-0 font-poppins'><p>As an enthusiast Web Developer and a Problem Solver, I excel in Frontend Development as well as Full-Stack Development. My ultimate goal is to contribute to projects that leverage technology for meaningful and impactful solutions.</p> </div></div>}

          {inView && <div className='icons flex items-center gap-8 tx opacity-0 md:py-5 py-[5px] '>
