...
const Contact = () => {
  ...
  return (
    <section ref={ref} name='contact' className='min-h-screen md:px-32 md:py-[52px] py-5'>
      <div className=' flex md:flex-row flex-col md:items-center md:gap-3  relative gap-12 '>
        <div className=' md:w-1/2 md:px-0 px-7'>
          ...
          {inView && <div className='cont-info opacity-0 flex flex-col gap-5 md:mt-10 mt-24 py-1'>
        ...
        <div className=' md:px-0 px-7 md:w-1/2 md:py-3 py-1.5 '>
          {inView && <form onSubmit={handleSubmit} className=' font-Kaushan opacity-0 form bg-[#0f0f0f] text-white flex flex-col py-7 md:px-5 px-2.5 gap-4'>
            ...
            <div className=' text-black flex justify-center items-center'> <input type='submit' className=' cursor-pointer text-[20px] hover:shadow-[0_0_15px_1px_#0ef] bg-[#0ef] py-2.5 px-10 rounded-full font-bold ' value={"Send"} /> </div>
